package net.mcreator.daemonium.item.renderer;
...
import net.mcreator.daemonium.item.model.DemonicScytheItemModel;
import net.mcreator.daemonium.item.DemonicScytheItem;
import net.mcreator.daemonium.interfaces.RendersPlayerArms;
...
public class DemonicScytheItemRenderer extends GeoItemRenderer<DemonicScytheItem> implements RendersPlayerArms {
	public DemonicScytheItemRenderer() {
		super(new DemonicScytheItemModel());
	}

	@Override
	public RenderType getRenderType(DemonicScytheItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof DemonicScytheItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new DemonicScytheItemRenderer();
	...
	protected DemonicScytheItem animatable;
	...
	@Override
	public void render(GeoModel model, DemonicScytheItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(DemonicScytheItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(DemonicScytheItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(DemonicScytheItem animatable) {
